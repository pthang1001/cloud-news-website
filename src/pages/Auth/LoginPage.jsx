    ...
    <div style={{ width: "100%", maxWidth: 520, minHeight: "100%", display: "flex", flexDirection: "column", justifyContent: "center" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 24 }}>
          ...
          <span style={{ fontSize: 11, color: "#94a3b8", letterSpacing: 1.5, fontWeight: 600 }}>HOẶC ĐĂNG NHẬP VỚI EMAIL</span>
          <div style={{ flex: 1, height: 1, background: "#e2e8f0" }} />
        </div>
      ...
      <p style={{ textAlign: "center", marginTop: 24, fontSize: 14, color: "#64748b" }}>
        ...
        <a href="/register" style={{ color: "#2563eb", fontWeight: 700, textDecoration: "none" }}>
          Đăng ký ngay
        </a>
      </p>
